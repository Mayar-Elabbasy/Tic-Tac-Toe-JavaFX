...
public  class FriendsScene extends AnchorPane {
    ...
    protected   ImageView oIconForGridButton;
    protected   ImageView xIconForGridButton;
    
    protected   ImageView oIconForGridButton0;
    protected   ImageView xIconForGridButton0;
   
    protected   ImageView oIconForGridButton1;
    protected   ImageView xIconForGridButton1;
    
    protected   ImageView oIconForGridButton2;
    protected   ImageView xIconForGridButton2;
   
    protected   ImageView oIconForGridButton3;
    protected   ImageView xIconForGridButton3;
    
    protected   ImageView oIconForGridButton4;
    protected   ImageView xIconForGridButton4;
   
    protected   ImageView oIconForGridButton5;
    protected   ImageView xIconForGridButton5;
    
    protected   ImageView oIconForGridButton6;
    protected   ImageView xIconForGridButton6;
    
    protected   ImageView oIconForGridButton7;
    protected   ImageView xIconForGridButton7;
